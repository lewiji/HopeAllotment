...
export default function Footer(props) {
  return <footer className="footer_pattern">
    <nav
      ...
      <p className={"pt-2 sm:pt-0 text-center text-xs break-words max-w-xs"}>Trade Base Trust is a registered charity,
        with Charity Registration number 1159828.</p>
      <p className="text-lg leading-relaxed text-right justify-center items-end font-green-500 hover:cursor-pointer">
        <a href={"https://prismic.io/"} target={"_blank"} rel={"noopener noreferrer"}>
          <StaticImage src={"../images/prismic-logo.svg"} alt={"Proudly powered by Prismic"} title={"Proudly powered by Prismic"}
                       width={32} height={32}  />
        </a>
      </p>
      <p className="text-lg leading-relaxed text-right justify-center items-end font-green-500 hover:cursor-pointer">
            <span role="img" aria-label="Green Heart (scroll to top)">
              <motion.svg initial={{ scale: 0.8, opacity: 0, pathLength: 0 }}
                          ...
                          className={"stroke fill-current float-right mr-2"}
                          height={32} width={32}>
