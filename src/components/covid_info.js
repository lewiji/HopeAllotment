...
const CovidInfo = () => {
  ...
  return (
    <>
      <div className="bg-blue-50 rounded text-blue-900 px-4 py-3 mt-2" role="alert">
        <div className="flex flex-row justify-start items-start">
          <div><svg className="fill-current h-6 w-6 text-blue-500 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM9 11V9h2v6H9v-4zm0-6h2v2H9V5z"/></svg></div>
          <div>
            <h3 className="text-blue-900 mt-0">CORONAVIRUS/COVID-19</h3>
            <p className="text-sm text-blue-500">The spread of COVID-19 (Coronavirus) is a concern for all of us and we are taking the
